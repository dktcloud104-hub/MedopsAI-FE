...
export default function Dashboard({ userEmail, onLogout }: DashboardProps) {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 flex overflow-hidden transition-colors duration-300">
      ...
      {/* Main Content */}
      <div className={`flex-1 ${isCollapsed ? 'lg:ml-20' : 'lg:ml-64'} transition-all duration-300 w-full min-w-0 flex flex-col h-screen overflow-hidden`}>
        {/* Header */}
      ...
      <button
        ...
        className="lg:hidden fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-xl transition-all z-30"
      >
