  ...
  return (
    <ThemeProvider>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-900 dark:to-slate-900 flex overflow-x-hidden transition-colors duration-300">
        ...
        {/* Main Content */}
        <div className={`flex-1 ${isCollapsed ? 'lg:ml-20' : 'lg:ml-64'} transition-all duration-300 w-full min-w-0`}>
          {/* Navbar */}
          <Navbar
            title="All Patients"
                      ...
                      <div className="flex gap-2 mb-4 border-b border-gray-200 dark:border-gray-700">
                        {selectedPatient.bill_details && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'bills'
                        ...
                        {selectedPatient.reports && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'reports'
                                ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                              }`}
                          >
                        ...
                        {selectedPatient.doctor_medical_certificate && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'certificate'
                                ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                              }`}
                          >
                        ...
                        {selectedPatient.medication_details?.discharge_summary_url && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'discharge'
                                ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                              }`}
                          >
                        ...
                        {selectedPatient.medication_details?.action_plan_pdf_url && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'action'
                                ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                              }`}
                          >
                        ...
                        {selectedPatient.insurer_justification_pdf_url && (
                          <button
                            ...
                            className={`px-4 py-2 font-semibold text-sm transition-all ${activeDocTab === 'insurer'
                                ? 'text-blue-600 dark:text-blue-400 border-b-2 border-blue-600 dark:border-blue-400'
                                : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                              }`}
                          >
